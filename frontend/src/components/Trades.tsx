...
import { VirtualizedTradesTable } from './VirtualizedTables';
    ...
    return (
      <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 overflow-hidden">
        ...
        <div className="relative text-center">
          ...
          <h3 className="text-3xl font-bold text-white mb-3">Error Loading Trades</h3>
    ...
    return (
      <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 overflow-hidden">
        ...
        <div className="relative text-center">
          ...
          <h3 className="text-3xl font-bold text-white mb-3">No Trades Found</h3>
    ...
    <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
      ...
      <div className="relative p-8">
        <VirtualizedTradesTable 
          data={tradesData} 
          onRowClick={(trade) => console.log('Trade clicked:', trade)}
        />
      </div>
    </div>
  );
